...
class TuiTruyen : HttpSource() {
    ...
    override fun pageListParse(response: Response): List<Page> {
        ...
        // Fallback: no IMGx protection, just extract image URLs
    ...
    private fun fetchPagesWithGrants(
        ...
        // Parse initial pages embedded in HTML
        val readerEl = document.selectFirst("[data-reader-imgx-initial-pages]")
        ...
        // Determine which page indices we still need to fetch
